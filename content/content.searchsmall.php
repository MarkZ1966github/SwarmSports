...
<form action="searchsmall.php" method="post" enctype="application/x-www-form-urlencoded">
  <input type='text' name='registersearchsmall' style='height:30px; width:200px'/>
  <input type='hidden' value='dummy' name='searchsmall' />
