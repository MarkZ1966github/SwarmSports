...
<?php
	...
	if($_POST['stories'])
	{
		include "logic/logic.stories.php";
	}
	...
	if($_POST['search'])
	{
		include "logic/logic.search.php";
	}

	//Check for search. Might be depreciated, commenting out 7/19/2013
//	if($_POST['search2'])
//	{
//		include "logic/logic.search2.php";
//	}
	
	//Check for search from chrome extension.
	if($_POST['searchsmall'])
	{
		include "logic/logic.searchsmall.php";
	}
?>