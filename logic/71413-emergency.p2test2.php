...
$query2="SELECT * FROM manualstuff";
...
<strong>
<?php 
$vr = file_get_contents('http://api.swarmsports.com/?action=viralrank&url='.$f3.'');
$vr = str_replace("{\"ViralRank\":"," ",$vr);
$vr = str_replace("}"," ",$vr);
echo $vr;
?>
</strong>
...
<td>
<a href="#" onClick="MyWindow=window.open('http://www.facebook.com/sharer/sharer.php?u=<?php echo $f3; ?>','MyWindow','toolbar=no,location=no,directories=no,status=no, menubar=no,scrollbars=no,resizable=no,width=805,height=235'); return false;">
<img src = './bootstrap/docs/assets/img/facebook-35x28.jpg'></a>
</td>
<td>
...
$query2="SELECT * FROM swarmrank2 $limit";
$result2=mysql_query($query2);
...
<td width = "600"><strong>Articles</strong></td>
...
<td width = "600"><a href = "<?php echo $f3; ?>"target ="_blank"><?php echo $f1; ?></a></td>
<td width = "40">
<?php echo $f2; ?>
</td>
<td width = "240"><?php echo date("F j, Y, g:i a", strtotime($f4)) ; ?><br />
</tr>
<?php
$i++;
}
